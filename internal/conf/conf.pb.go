...
type Server struct {
	...
	Discord *Server_Discord `protobuf:"bytes,2,opt,name=discord,proto3" json:"discord,omitempty"`
}
...
func (x *Server) GetDiscord() *Server_Discord {
	if x != nil {
		return x.Discord
	}
	return nil
...
func (x *Server_Discord) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Discord) ProtoMessage() {}

func (x *Server_Discord) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Discord.ProtoReflect.Descriptor instead.
func (*Server_Discord) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 1}
}

func (x *Server_Discord) GetUserToken() string {
	if x != nil {
		return x.UserToken
	}
	return ""
...
func (x *Server_Discord) GetBotToken() string {
	if x != nil {
		return x.BotToken
	}
	return ""
...
func (x *Server_Discord) GetServerId() string {
	if x != nil {
		return x.ServerId
	}
	return ""
...
func (x *Server_Discord) GetChannelId() string {
	if x != nil {
		return x.ChannelId
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xda, 0x02, 0x0a,
	...
	0x68, 0x74, 0x74, 0x70, 0x12, 0x34, 0x0a, 0x07, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x72, 0x64, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x72,
	0x64, 0x52, 0x07, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x72, 0x64, 0x1a, 0x69, 0x0a, 0x04, 0x48, 0x54,
	...
	0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x81, 0x01, 0x0a, 0x07, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x72,
	...
	0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x64, 0x22, 0xdd, 0x02, 0x0a, 0x04, 0x44, 0x61,
	...
	0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x1b, 0x5a, 0x19, 0x73, 0x65, 0x72,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_Discord)(nil),      // 4: kratos.api.Server.Discord
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	4, // 3: kratos.api.Server.discord:type_name -> kratos.api.Server.Discord
